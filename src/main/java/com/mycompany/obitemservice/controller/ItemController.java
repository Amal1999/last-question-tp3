...
public class ItemController {
    ...
    @PostMapping("/items")
    public ResponseEntity<String> saveItem(@ModelAttribute(name = "item") Item item) {
        System.out.println("------------- hello save ------------");
        Item savedItem = itemRepository.insert(item);//it will create new document in table with autogenerated id, if id exist than exception in is thrown
