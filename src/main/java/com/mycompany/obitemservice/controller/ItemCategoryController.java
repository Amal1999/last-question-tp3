...
public class ItemCategoryController {
    ...
    public ResponseEntity<String> saveItemCategory(@RequestBody ItemCategory categoryModel) {
        ItemCategory savedItem = itemCategoryRepository.insert(categoryModel);//it will create new document in table with autogenerated id, if id exist than exception in is thrown
